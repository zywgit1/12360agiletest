...
public interface PersonDao {
    ...
    @Insert("insert into ticket_order (person_id,ticket_id,create_time,price) values(#{person_id},#{ticket_id},#{create_time},#{price})")
    public boolean createTicketOrder(Integer person_id, Integer ticket_id, Timestamp create_time, Float price);
